...
export const ChatLog = ({ messages }: { messages: ChatEntry[] }) => {
  ...
  return (
    <div className="pointer-events-auto w-80 flex flex-col transition-all duration-300 ease-in-out">
      ...
      {/* Message Area: Controlled by isCollapsed */}
      <div
            ...
            <div
              ...
              className={`px-2 py-0.5 mb-1 rounded text-[13px] leading-tight border-l-2 ${
                msg.isSystem
                  ...
                  : "bg-white/5 border-transparent text-white/90"
              }`}
            >
              {!msg.isSystem && (
                <span className="text-yellow-500/80 font-mono font-bold mr-1 text-[11px]">
